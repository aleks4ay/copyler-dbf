...
public class CopyDescription {
    ...
    public static void main(String[] args) {
        new CopyDescription().run("c:/1C/Copy250106/DT1898.DBF", "c:/1C/Copy250106/SC14716.DBF");
    }

    public void run(String descriptionFileName, String embodimentFileName) {
        log.info("   writing 'D E S C R I P T I O N'.");
        try {
            byte[] byteArrayEmbodiment = new File1CReader().file2byteArray(embodimentFileName);
            byte[] byteArrayDescription = new File1CReader().file2byteArray(descriptionFileName);
            ...
            Map<String, String> mapEmbodiment = new EmbodimentReader().getAllEmbodiment(byteArrayEmbodiment);
